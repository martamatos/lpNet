#
# get adjacency matrix when solving LP problem with lpSolve
#
getAdja <-function(result,numnodes, annot=NULL)
{
...
#
# get adjacency matrix when solving LP problem with gurobi
#
getAdja_gurobi <-function(result,numnodes, annot)
{
	edges <- cbind(result$x,annot)
