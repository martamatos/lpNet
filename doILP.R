doILP <-
function(obs,delta,lambda,lambda2=NULL,b,n,K,T_=NULL,annot,previousNet=NULL,baseline=NULL,previousBaseline=NULL,prior=NULL,sourceNode=NULL,sinkNode=NULL,all.int=FALSE,all.pos=FALSE)
{
  if(all.int){
	delta <- rep(1,n)
  }
