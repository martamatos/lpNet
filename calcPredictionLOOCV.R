...
calcPredictionLOOCV_dyn_sahin03 <-function(rem_t,kds,adja,obs,delta,rem_kd,rem_gene,active_mu,active_sd,inactive_mu,inactive_sd)
{
  # which genes are silenced in removed observation
  sil_gene_ids <- which(kds[,rem_kd,rem_t]==0)
...
calcPredictionLOOCV_dyn_ddepn <-function(rem_t,kds,adja,obs,delta,rem_kd,rem_gene,active_mu,active_sd,inactive_mu,inactive_sd)
{
  # which genes are silenced in removed observation
  sil_gene_ids <- which(kds[,rem_kd,rem_t]==0)
